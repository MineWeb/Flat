        ...
        <div class="card-body">
          ...
          <div class="tabbable">
            <ul class="nav nav-tabs">
             <li class="active"><a class="nav-link text-dark" href="#tab1" data-toggle="tab">Options principales</a></li>
             <li><a href="#tab2" class="nav-link text-dark" data-toggle="tab">Sidebar</a></li>
			       <li><a class="nav-link text-dark" href="#tab3" data-toggle="tab">Navbar</a></li>
            </ul>
